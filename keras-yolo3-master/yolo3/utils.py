...
def get_random_data(annotation_line, input_shape,
    random=True, max_boxes=20, jitter=.2, hue=.1, sat=1.3, val=1.3, proc_img=True):
    '''random preprocessing for real-time data augmentation'''
    try:
        image_path, line = annotation_line.split(sep="<path end>",maxsplit=1)
    except:
        print(".........................................................")
        print(annotation_line)
        print(".........................................................")
        image_path = annotation_line
        line = ""
    line = line.split()
